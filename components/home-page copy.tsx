    ...
    <div className="bg-white">
      ...
      <section className="py-12 px-4 md:px-8 lg:px-16 bg-gray-50">
        ...
        >
          <div className="p-6 text-center">
            ...
            <p className="text-gray-600 mb-6">Scan the QR code below to follow us on Instagram for the latest updates and inspiration!</p>
            <motion.div
              whileHover={{ scale: 1.05 }}
              className="bg-gray-200 w-48 h-48 mx-auto rounded-lg flex items-center justify-center"
            >
              <span className="text-gray-500">QR Code Placeholder</span>
            </motion.div>
            <p className="mt-4 text-sm text-gray-500">@wallaura_official</p>
          </div>
        </motion.div>
      </section>
      ...
      <footer className="bg-gray-100 py-8 px-4 md:px-8 lg:px-16">
        ...
        <div className="mt-8 text-center text-gray-600">
          <p>&copy; 2023 Wallaura. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
